...
CFLAGS+=-Iinclude/ -DHAVE_JPEG -ljpeg

CXX?=g++
CXXFLAGS?=-O2 -fomit-frame-pointer
CXXFLAGS+=-Iinclude/ -DHAVE_JPEG -ljpeg
...
all: libyuv.a i444tonv12_eg yuvconvert yuvconstants cpuid server client
...
# A C++ test utility that uses libyuv conversion.
server: util/server.c libyuv.a
	$(CXX) $(CXXFLAGS) -Iutil/ -o $@ util/server.c libyuv.a -ljpeg

# A C++ test utility that uses libyuv conversion.
client: util/client.c libyuv.a
	$(CXX) $(CXXFLAGS) -Iutil/ -o $@ util/client.c libyuv.a -ljpeg

...
class StatGatheringParams : public ndnrtc::Params
{
  public:
    ...
    StatGatheringParams() {}
    StatGatheringParams(const StatGatheringParams &sgp) : statFileName_(sgp.statFileName_), gatheredStatistcs_(sgp.getStats()) {}
    ...
    void write(std::ostream &os) const
    {
        ...
        for (int i = 0; i < gatheredStatistcs_.size(); i++)
        {
            ...
            if (i != gatheredStatistcs_.size() - 1)
                os << ", ";
        }
        os << ")";
    }
...
class ClientMediaStreamParams : public ndnrtc::MediaStreamParams
{
  public:
    ...
    ClientMediaStreamParams(const ClientMediaStreamParams &params) : MediaStreamParams(params), sessionPrefix_(params.sessionPrefix_) {}
...
class ProducerStreamParams : public ClientMediaStreamParams
{
  public:
    ...
    ProducerStreamParams() : source_({"", "pipe"}) {}
...
class ConsumerClientParams : public ndnrtc::Params
{
  public:
    ...
    ConsumerClientParams(const ConsumerClientParams &params) : generalAudioParams_(params.generalAudioParams_),
...
class ProducerClientParams : public ndnrtc::Params
{
  public:
    ...
    ProducerClientParams(const ProducerClientParams &params) : prefix_(params.prefix_),

...
//liupenghui, add type	MediaStreamParams::MediaStreamType::MediaStreamTypeAudio

RemoteAudioStreamImpl::RemoteAudioStreamImpl(boost::asio::io_service &io,
                                             const boost::shared_ptr<ndn::Face> &face,
                                             const boost::shared_ptr<ndn::KeyChain> &keyChain,
                                             const std::string &streamPrefix)
    : RemoteStreamImpl(io, face, keyChain, streamPrefix, MediaStreamParams::MediaStreamType::MediaStreamTypeAudio)
    , io_(io)
{   
    construct();

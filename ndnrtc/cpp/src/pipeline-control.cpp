...
void PipelineControl::segmentStarvation()
{
    ...
    #if 0
    //interestControl_->continueadd(100);
    PipelineAdjust cmd = PipelineAdjust::IncreasePipeline;
    needPipelineAdjustment(cmd);
    pipeliner_->fillUpPipeline(machine_.ppCtrl_->threadPrefix_);
    #else
